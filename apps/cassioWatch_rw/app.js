...
function drawClock() {
  ...
  g.setColor(0, 0, 0);
  g.drawString(require("locale").time(new Date(), 1), -10, 67);
  g.setFont("8x12", 2);
...
function draw() {
  ...
  heart = Math.round(Bangle.getHealthStatus(undefined).bmp);
  offset_h = heart >= 100 ? 155 : 148;
