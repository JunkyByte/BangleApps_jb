...
function drawClock() {
  ...
  g.setFont("8x12");
  g.drawString(require("locale").month(new Date(), 2).toUpperCase(), 56, 110);
  // g.setFont("8x12", 2);
  g.setFont("7x11Numeric7Seg", 2);
  const time = new Date().getDate();
  g.drawString(time < 10 ? "0" + time : time, 56, 123);
}
